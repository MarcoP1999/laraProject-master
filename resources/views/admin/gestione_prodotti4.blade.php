...
@section('breadcrumb')
    ...
    <li><a href="{{ route('gestione_prod4') }}">Admin</a></li>
@endsection
                ...
                @foreach($prodotti as $prodotto)
                    <li id="elemento_lista">
                        <div class="riquadro_concerto">
                            <div class=""> <img src="{{ asset('images/' . $prodotto->image_catalogo) }}" alt="" class="immagine_prodotto" style="height: 100px; width: 100px; "> </div>
